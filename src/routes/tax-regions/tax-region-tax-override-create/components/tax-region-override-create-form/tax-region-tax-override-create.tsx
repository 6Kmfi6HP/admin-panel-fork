...
export const TaxRegionCreateTaxOverrideForm = ({
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="tax-region-override-create-form"
    >
      <KeyboundForm
      ...
      >
        ...
        <RouteFocusModal.Body
          ...
          data-testid="tax-region-override-create-form-body"
        >
          <div className="flex flex-1 flex-col items-center overflow-y-auto">
            <div className="flex w-full max-w-[720px] flex-col gap-y-8 px-2 py-16">
              <div data-testid="tax-region-override-create-form-header-section">
                ...
                <RouteFocusModal.Description asChild>
                  <Text
                    ...
                    data-testid="tax-region-override-create-form-hint"
                  >
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="tax-region-override-create-form-name-item">
                            <Form.Label data-testid="tax-region-override-create-form-name-label">
                              {t('fields.name')}
                            </Form.Label>
                            <Form.Control data-testid="tax-region-override-create-form-name-control">
                              <Input
                                {...field}
                                data-testid="tax-region-override-create-form-name-input"
                              />
                            </Form.Control>
                        ...
                        return (
                          <Form.Item data-testid="tax-region-override-create-form-code-item">
                            ...
                            <Form.Control data-testid="tax-region-override-create-form-code-control">
                              <Input
                                {...field}
                                data-testid="tax-region-override-create-form-code-input"
                              />
                            </Form.Control>
              ...
              <div
                ...
                data-testid="tax-region-override-create-form-targets-section"
              >
                <div
                  className="flex items-center justify-between gap-x-4"
                  data-testid="tax-region-override-create-form-targets-header"
                >
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="tax-region-override-create-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            ...
            <Button
              ...
              type="submit"
              isLoading={isPending}
              data-testid="tax-region-override-create-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
