...
export const ShippingOptionTypeGeneralSection = ({
  ...
  return (
    <Container
      ...
      data-testid="shipping-option-type-general-section-container"
    >
      <div
        className="flex items-center justify-between px-6 py-4"
        data-testid="shipping-option-type-general-section-header"
      >
        <Heading data-testid="shipping-option-type-general-section-heading">
          {shippingOptionType.label}
        </Heading>
        <ActionMenu
          groups={[
      ...
      <div
        ...
        data-testid="shipping-option-type-general-section-code-row"
      >
        <Text
          size="small"
          leading="compact"
          weight="plus"
          data-testid="shipping-option-type-general-section-code-label"
        >
          {t('fields.code')}
        </Text>
        <Text
          size="small"
          leading="compact"
          data-testid="shipping-option-type-general-section-code-value"
        >
      ...
      <div
        className="grid grid-cols-2 items-start px-6 py-4 text-ui-fg-subtle"
        data-testid="shipping-option-type-general-section-description-row"
      >
        <Text
          size="small"
          leading="compact"
          weight="plus"
          data-testid="shipping-option-type-general-section-description-label"
        >
        ...
        <Text
          size="small"
          leading="compact"
          data-testid="shipping-option-type-general-section-description-value"
        >
