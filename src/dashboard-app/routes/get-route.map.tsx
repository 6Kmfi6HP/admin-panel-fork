          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: '',
                  lazy: () => import('../../routes/blog/article-list'),
                  children: [
                    {
                      path: 'create',
                      lazy: () => import('../../routes/blog/article-create')
                    }
                  ]
                },
                {
                  path: 'categories',
                  lazy: () => import('../../routes/blog/category-list')
                },
                {
                  path: 'tags',
                  lazy: () => import('../../routes/blog/tag-list')
                },
                {
                  path: ':id',
                  lazy: () => import('../../routes/blog/article-detail')
                }
              ]
            },
            {
              ...
              children: [
                {
                  ...
                  lazy: () => import('../../routes/requests/request-seller-list')
                },
                {
                  path: 'review-remove',
                  handle: {
                  ...
                  lazy: () => import('../../routes/requests/request-review-remove-list')
                },
                {
                  path: 'product',
                  handle: {
                  ...
                  children: [
                    {
                      path: '',
                      lazy: () => import('../../routes/requests/request-product-list')
                    },
                    {
                      path: ':id',
                      lazy: () => import('../../routes/requests/request-product-details')
                    }
                  ]
                },
                {
                  ...
                  lazy: () => import('../../routes/requests/request-return-list')
                },
                {
                  ...
                  lazy: () => import('../../routes/requests/request-product-collection-list')
                },
                {
                  ...
                  lazy: () => import('../../routes/requests/request-product-category-list')
                },
                {
                  path: 'product-update',
                  handle: {
                  ...
                  lazy: () => import('../../routes/requests/request-product-update-list')
                },
                {
                  path: 'product-tag',
                  handle: {
                  ...
                  lazy: () => import('../../routes/requests/request-product-tag-list')
                },
                {
                  path: 'product-type',
                  handle: {
                  ...
                  lazy: () => import('../../routes/requests/request-product-type-list')
                }
              ]
            },
            {
          ...
          children: [
                  ...
                  children: [
                    {
                      ...
                      children: [
                        ...
                        {
                          path: 'metadata/edit',
                          lazy: () => import('../../routes/tax-regions/tax-region-metadata')
                        }
                      ]
                    },
                    {
            ...
            },
            {
              ...
              children: [
                ...
                {
                  path: 'create',
                  lazy: () => import('../../routes/attributes/attribute-create')
                },
                {
                  path: ':id',
                  children: [
                    {
                      path: '',
                      lazy: () => import('../../routes/attributes/attribute-detail')
                    },
                    {
                      path: 'edit',
                      lazy: () => import('../../routes/attributes/attribute-edit')
                    },
                    {
                      path: 'edit-possible-value',
                      lazy: () => import('../../routes/attributes/attribute-edit-possible-value')
                    }
                  ]
                }
              ]
